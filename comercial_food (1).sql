...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-03-2024 a las 15:27:56
...
(8, 'Lacteos', 'leche, yogurt y queso'),
(9, 'Panaderia', 'panes y repostería'),
(10, 'Galleteria', 'galletas saladas y dulces'),
(11, 'Golosinas', 'Chupetas, caramelos y bombones'),
(12, 'Salsas', 'salsa de tomate y aderezos'),
(13, 'Refrescos', 'Bebidas gaseosas y jugos'),
(14, 'Carnes Frías', 'Salchichas, mortadelas y jamones');
...
CREATE TABLE `contratista` (
  ...
  `apellido2` varchar(25) NOT NULL,
  `tipo_documento` enum('CC','CE','NIT','RUT') DEFAULT NULL,
  `no_documento` varchar(25) DEFAULT NULL,
  `sexo` enum('masculino','femenino') DEFAULT NULL,
  `direccion` varchar(50) NOT NULL,
  `telefono` varchar(25) NOT NULL,
...
(1, 'Gonzalo', '', 'Betancur', 'Arroyave', 'CC', '80161094', '', 'cra 78c # 5c 48', 'bogota', 30, '3145778421', '2024-03-14', 'soltero', 1, '', 'sanitas', 'colfondos', 'fna', 'BBVA', 'A'),
(2, 'Santiago', '', 'Betancurt', 'Lemos', 'CC', '79843321', '', 'cra 71d # 7a 48', 'bogota', 32, '3202568945', '2024-03-14', 'casado', 1, 'tecnico', 'sura', 'proteccion', '', 'davivienda', 'A'),
(3, 'Isabella', '', 'Marquez', 'Jaramillo', 'CC', '52951079', 'femenino', 'CALLE 28 #58-69', 'barranquilla', 28, '3457634512', '2024-03-14', 'viudo', 2, '', 'capital salud', 'colfondos', 'colfondos', '', 'A'),
(4, 'Karla', 'Maria', 'Molina', 'Lema', 'CC', '53456798', 'femenino', 'cra 78c # 5c 25', 'cali', 34, '3124772431', '2024-03-14', 'casado', 2, 'tecnico', 'nueva eps', 'proteccion', 'fna', 'popular', 'A'),
(5, 'Hilda', '', 'Rodriguez', 'Caro', 'CC', '1020567980', 'femenino', 'Av 68 # 5a _45', 'bogota', 31, '3025975960', '2024-03-14', 'casado', 2, '', 'sanitas', 'porvenir', 'proteccion', '', 'A'),
(6, 'Victoria', '', 'Hincapie', 'Vergara', 'CC', '19654789', 'femenino', 'Calle 10 # 5-51', 'medellin', 22, '3103336590', '2024-03-14', 'union libre', 2, '', 'sura', 'porvenir', 'colfondos', 'popular', 'A'),
(7, 'Pablo', 'Santiago', 'Rojas', 'Duque', 'CC', '1018765324', '', 'Calle 100 # 11B-27 Bogotá', 'bogota', 25, '3456676895', '2024-03-14', 'soltero', 2, 'primaria', 'capital salud', 'colfondos', 'fna', 'davivienda', 'A'),
(8, 'Pamela', '', 'Serna', 'Muñoz', 'CC', '1010654382', 'femenino', 'Calle 53 No 10-60/46, Pis', 'barranquilla', 40, '3225986478', '2024-03-14', 'union libre', 2, 'tecnico', 'nueva eps', 'skandia', '', 'BBVA', 'A'),
(9, 'Stepania', '', 'Zapata', 'Pelaez', 'CC', '1014343567', 'femenino', 'Carrera 21 # 17 -63', 'cali', 25, '3028912345', '2024-03-14', 'casado', 2, '', 'sanitas', 'porvenir', 'fna', 'davivienda', 'A'),
(10, 'Manuel', 'Andres', 'Toro', 'Sanchez', 'CC', '1013567900', '', 'Calle 24D #5676', 'medellin', 28, '3026598745', '2024-03-14', 'casado', 2, '', 'sura', 'skandia', 'colfondos', 'popular', 'A'),
(11, 'Barbara', '', 'Henao', 'Cano', 'CC', '51593856', 'femenino', 'CALLE 12#45-17', 'bogota', 35, '8018043009', '2024-03-14', 'viudo', 4, '', 'capital salud', 'colfondos', 'colfondos', '', 'A'),
(12, 'Leonardo', '', 'Vasquez', 'Uribe', 'CC', '79804568', '', 'Av 26 No 59-51 Edificio A', 'medellin', 24, '3201452698', '2024-03-14', 'union libre', 4, 'tecnico', 'nueva eps', 'proteccion', 'proteccion', '', 'A'),
(13, 'Juliana', '', 'Castrillón', 'Florez', 'CC', '1015678904', 'femenino', 'Av Boyaca #  2a 71', 'cali', 32, '3412589678', '2024-03-14', 'soltero', 3, '', 'sanitas', 'colfondos', 'colfondos', 'davivienda', 'A'),
(14, 'Rocio', '', 'Muñoz', 'Gutierrez', 'CC', '1015768903', 'femenino', 'CR 5B #50-49A SUR', 'barranquilla', 37, '3125847512', '2024-03-14', 'casado', 3, 'tecnico', 'sura', 'porvenir', '', 'BBVA', 'A');
...
(191, 1, 1, 10, 3000, 0.00),
(192, 1, 2, 5, 8000, 0.00),
(193, 1, 3, 4, 3000, 0.00),
(194, 2, 1, 10, 3000, 0.00),
(195, 2, 2, 5, 8000, 0.00),
(196, 2, 3, 4, 3800, 0.00),
(197, 3, 4, 10, 5500, 0.10),
(198, 3, 5, 6, 7500, 0.10),
(199, 3, 8, 5, 6500, 0.10),
(200, 4, 4, 10, 5500, 0.10),
(201, 4, 5, 6, 7500, 0.10),
(202, 4, 8, 5, 6500, 0.10),
(203, 5, 10, 5, 7500, 0.10),
(204, 5, 4, 7, 5500, 0.10),
(205, 6, 8, 5, 6500, 0.10),
(206, 6, 5, 10, 7500, 0.10),
(207, 7, 2, 15, 6500, 0.00),
(208, 8, 7, 20, 5500, 0.05),
(209, 8, 9, 18, 8500, 0.05),
(210, 9, 12, 13, 6500, 0.00),
(211, 9, 13, 30, 8500, 0.00),
(212, 9, 14, 23, 10000, 0.00),
(213, 10, 11, 7, 6500, 0.10),
(214, 10, 10, 13, 7500, 0.10),
(215, 10, 13, 20, 8500, 0.10),
(216, 11, 14, 15, 10000, 0.00),
(217, 11, 15, 30, 8200, 0.00),
(218, 11, 5, 17, 7500, 0.00),
(219, 12, 16, 30, 9000, 0.15),
(220, 12, 15, 50, 8200, 0.15),
(221, 12, 14, 24, 10000, 0.15),
(222, 13, 17, 30, 7300, 0.00),
(223, 13, 18, 40, 6600, 0.00),
(224, 13, 19, 25, 3880, 0.10),
(225, 14, 20, 15, 7000, 0.05),
(226, 14, 21, 10, 9000, 0.05),
(227, 15, 22, 34, 3100, 0.05),
(228, 15, 23, 55, 3500, 0.05),
(229, 16, 24, 43, 4400, 0.10),
(230, 16, 25, 32, 5200, 0.10),
(231, 17, 26, 28, 2800, 0.00),
(232, 17, 27, 16, 3500, 0.00),
(233, 18, 28, 26, 7000, 0.00),
(234, 19, 10, 40, 7500, 0.10),
(235, 19, 11, 25, 6500, 0.10),
(236, 20, 12, 17, 6500, 0.10),
(237, 20, 13, 50, 8500, 0.10),
(238, 20, 14, 36, 10000, 0.00),
(239, 21, 4, 30, 5500, 0.10),
(240, 21, 5, 26, 7500, 0.05),
(241, 22, 7, 30, 5500, 0.05),
(242, 22, 8, 16, 6500, 0.05),
(243, 23, 9, 20, 8500, 0.10),
(244, 23, 10, 30, 7500, 0.10),
(245, 24, 11, 50, 6500, 0.10),
(246, 24, 12, 28, 6500, 0.05),
(247, 24, 13, 16, 8500, 0.05),
(248, 25, 14, 12, 10000, 0.05),
(249, 25, 15, 10, 8200, 0.10),
(250, 26, 16, 30, 9000, 0.05),
(251, 26, 17, 20, 7300, 0.05),
(252, 27, 18, 15, 6600, 0.10),
(253, 27, 19, 22, 3880, 0.10),
(254, 27, 20, 13, 7000, 0.10),
(255, 28, 21, 25, 9000, 0.00),
(256, 28, 22, 15, 3100, 0.00),
(257, 28, 23, 7, 3500, 0.00),
(258, 29, 24, 11, 4400, 0.00),
(259, 29, 25, 4, 5200, 0.00),
(260, 30, 26, 10, 2800, 0.00),
(261, 31, 27, 14, 3500, 0.10),
(262, 31, 28, 12, 7000, 0.05),
(263, 32, 4, 20, 5500, 0.10),
(264, 32, 5, 15, 7500, 0.10),
(265, 33, 6, 20, 3500, 0.00),
(266, 33, 7, 16, 5500, 0.00),
(267, 34, 8, 24, 6500, 0.10),
(268, 34, 9, 18, 8500, 0.05),
(269, 35, 10, 30, 7500, 0.00),
(270, 35, 11, 23, 6500, 0.10),
(271, 36, 12, 37, 6500, 0.05),
(272, 36, 13, 26, 8500, 0.10),
(273, 37, 14, 22, 10000, 0.10),
(274, 37, 15, 31, 8200, 0.10),
(275, 38, 16, 15, 9000, 0.00),
(276, 38, 17, 29, 7300, 0.00),
(277, 38, 18, 30, 6600, 0.00),
(278, 38, 19, 25, 3880, 0.00),
(279, 39, 20, 40, 7000, 0.00),
(280, 39, 22, 28, 3100, 0.00),
(281, 39, 21, 37, 9000, 0.00),
(282, 39, 24, 24, 4400, 0.00),
(283, 39, 26, 10, 2800, 0.00),
(284, 39, 25, 14, 5200, 0.00),
(285, 39, 28, 20, 7000, 0.00);
...
ALTER TABLE `productos`
  ...
  ADD KEY `categoria_cod` (`categor_cod`),
  ADD KEY `proveedor_cod` (`proveedor_cod`);
...
--
ALTER TABLE `cliente`
  MODIFY `cod_cliente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
...
--
ALTER TABLE `empleado`
  MODIFY `cod_empleado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `factura_detalle`
  MODIFY `cod_facdetalle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=286;
